...
| `year` | Film release year, or series premiere / first-release year. Gregorian calendar (e.g. `2019`; not Buddhist Era). |
| `date` | First watch date from history, `YYYY-MM-DD` (oldest date for that collapsed work). |
